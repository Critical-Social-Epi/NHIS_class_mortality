...
# investigate how to estimate change in inequities over time - problematic in survival settings? might want to compute absolute risks in case HR increasing because RD decreasing with less f/u
