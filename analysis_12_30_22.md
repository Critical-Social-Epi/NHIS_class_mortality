...
love.plot(covs,
          ...
          weights=dat_sub_no_hisp$sw_f_over, 
          threshold=c(m=0.1), 
          which=.all) +
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
love.plot(covs,
          ...
          weights=dat_sub_no_hisp$sw_f_sub, 
          threshold=c(m=0.1), 
          which=.all) +
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
love.plot(covs,
          treat=dat_sub_no_hisp$class, 
          weights=dat_sub_no_hisp$sw_f_over_adj, 
          threshold=c(m=0.1), 
          which=.all) +
  facet_wrap(~treat, nrow=2) +
  scale_color_manual(values=c("#77AADD", "#114477")) +
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-23-1.png)<!-- -->
...
love.plot(covs,
          treat=dat_sub_no_hisp$class_occ, 
          weights=dat_sub_no_hisp$sw_f_sub_adj, 
          threshold=c(m=0.1), 
          which=.all) +
  facet_wrap(~treat, nrow=4) +
  scale_color_manual(values=c("#77AADD", "#114477")) +
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-26-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-31-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-36-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-41-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-45-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-50-1.png)<!-- -->
...
![](analysis_12_30_22_files/figure-html/unnamed-chunk-65-1.png)<!-- -->
